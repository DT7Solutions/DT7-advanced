...
a.btn {
  ...
  border: 1px solid var(--dca-gray-lighter) !important;
...
a.btn:focus {
  ...
  filter: brightness(var(--focus-brightness)) !important;
...
a.btn[disabled], a.btn[disabled]:hover, a.btn[disabled]:focus, a.btn[disabled]:active {
  background-color: var(--dca-white) !important;
  opacity: 0.4;
  border-color: rgba(var(--dca-gray-lighter), 0.4) !important;
  color: rgba(var(--dca-gray-darker), 0.8) true;
  cursor: not-allowed;
  box-shadow: none !important;
}
a.btn[disabled]:before, a.btn[disabled]:hover:before, a.btn[disabled]:focus:before, a.btn[disabled]:active:before {
  opacity: 0.4 true;
}
...
.submit-row .deletelink-box, .submit-row .deletelink {
  display: inline-block;
  float: left;
}
...
.cms-btn-group[disabled]:before, .cms-btn-group[disabled]:hover:before, .cms-btn-group[disabled]:focus:before, .cms-btn-group[disabled]:active:before {
  opacity: 0.4 true;
}
...
.cms_btn-active[disabled]:before, .cms_btn-active[disabled]:hover:before, .cms_btn-active[disabled]:focus:before, .cms_btn-active[disabled]:active:before {
  opacity: 0.4 true;
}
...
.colM ul:not(.object-tools):not(.messagelist):empty {
  border-bottom: 0;
}
.colM ul:not(.object-tools):not(.messagelist) li {
  color: var(--dca-gray-darkest);
  font-size: 14px;
  font-weight: bold;
  list-style-type: none;
  padding: 10px 0;
  border-top: solid 1px var(--dca-gray-lighter);
}
.colM ul:not(.object-tools):not(.messagelist) ul {
  margin: 10px 0 -10px;
  border-bottom: 0;
}
.colM ul:not(.object-tools):not(.messagelist) ul li {
  font-weight: normal;
  padding-left: 2%;
}
.colM ul:not(.object-tools):not(.messagelist) ul ul {
  margin-left: 20px;
}
.colM ul:not(.object-tools):not(.messagelist) ul ul li {
  padding-left: 0;
  padding-right: 0;
}
...
pre.literal-block {
  background: var(--dca-gray-lighter);
}
...
ul.messagelist li {
  ...
  background-color: var(--dca-gray-darker) !important;
  border-bottom: 0;
}
...
.related-lookup:focus {
  color: var(--dca-white) !important;
  background-color: var(--dca-primary) !important;
  border-color: var(--dca-primary) !important;
  filter: brightness(var(--focus-brightness)) !important;
  text-decoration: none !important;
}
.related-lookup:hover {
...
.related-lookup[disabled], .related-lookup[disabled]:hover, .related-lookup[disabled]:focus, .related-lookup[disabled]:active {
  background-color: var(--dca-primary) !important;
  opacity: 0.4;
  border-color: rgba(var(--dca-primary), 0.4) !important;
  color: rgba(var(--dca-white), 0.8) true;
  cursor: not-allowed;
  box-shadow: none !important;
}
.related-lookup[disabled]:before, .related-lookup[disabled]:hover:before, .related-lookup[disabled]:focus:before, .related-lookup[disabled]:active:before {
  opacity: 0.4 true;
}
.related-lookup:before {
  color: var(--dca-white);
...
.view-related:active:hover,
.view-related:active:focus {
  color: var(--dca-gray-darker) !important;
  background-color: var(--dca-white) !important;
  border-color: var(--dca-gray-lighter) !important;
  filter: brightness(calc(var(--focus-brightness) * var(--active-brightness))) !important;
...
.view-related[disabled]:hover,
.view-related[disabled]:focus,
.view-related[disabled]:active {
  background-color: var(--dca-white) !important;
  opacity: 0.4;
  border-color: rgba(var(--dca-gray-lighter), 0.4) !important;
  color: rgba(var(--dca-gray-darker), 0.8) true;
...
.add-another[disabled]:before, .add-another[disabled]:hover:before, .add-another[disabled]:focus:before, .add-another[disabled]:active:before,
.add-related[disabled]:before,
.add-related[disabled]:hover:before,
.add-related[disabled]:focus:before,
.add-related[disabled]:active:before,
.change-related[disabled]:before,
.change-related[disabled]:hover:before,
.change-related[disabled]:focus:before,
.change-related[disabled]:active:before,
.delete-related[disabled]:before,
.delete-related[disabled]:hover:before,
.delete-related[disabled]:focus:before,
.delete-related[disabled]:active:before,
.view-related[disabled]:before,
.view-related[disabled]:hover:before,
.view-related[disabled]:focus:before,
.view-related[disabled]:active:before {
  opacity: 0.4 true;
}
.add-another:before,
.add-related:before,
...
.cms-admin-modal .main.shifted .content {
...
form fieldset, form .inline-group {
  width: 80%;
}
form .flex-container {
  display: block;
...
form .flex-container.form-multiline div.fieldBox {
  display: block;
}
form .flex-container.form-multiline > div:has(> div.hidden) {
  display: none;
}
...
form .form-row div > label:not(.vCheckboxLabel) {
  color: var(--dca-gray-darker) !important;
...
form .form-row > .fieldBox, form .form-row > div:not([class]) > .fieldBox, form .form-row > div:not([class]) > .flex-container > div:not(.related-widget-wrapper, .cke, .widget),
form .form-row .form-multiline > div:not(.related-widget-wrapper,
...
form .form-row > .fieldBox > label, form .form-row > div:not([class]) > .fieldBox > label, form .form-row > div:not([class]) > .flex-container > div:not(.related-widget-wrapper, .cke, .widget) > label,
form .form-row .form-multiline > div:not(.related-widget-wrapper,
.form-multiline > div:not([class]) > div:not(.related-widget-wrapper),
.cke, .widget) > label {
  text-transform: inherit;
}
form .form-row > .fieldBox + .fieldBox, form .form-row > div:not([class]) > .fieldBox + .fieldBox, form .form-row > div:not([class]) > .flex-container > div:not(.related-widget-wrapper, .cke, .widget) + .fieldBox,
form .form-row .form-multiline > div:not(.related-widget-wrapper,
.form-multiline > div:not([class]) > div:not(.related-widget-wrapper),
.cke, .widget) + .fieldBox {
  padding-top: 0;
}
form .form-row > .fieldBox:not(:first-child), form .form-row > div:not([class]) > .fieldBox:not(:first-child), form .form-row > div:not([class]) > .flex-container > div:not(.related-widget-wrapper, .cke, .widget):not(:first-child),
form .form-row .form-multiline > div:not(.related-widget-wrapper,
.form-multiline > div:not([class]) > div:not(.related-widget-wrapper),
.cke, .widget):not(:first-child) {
  border-top: none;
}
...
form input + p.help,
form textarea + p.help,
form select + p.help,
form input + div.help,
form textarea + div.help,
form select + div.help {
  padding-left: 0;
  margin-left: 0;
}
form div + div.help {
...
form select {
  ...
  border: 1px solid var(--dca-gray-lighter);
  border-radius: 3px;
  background: var(--dca-white) url("../img/icon_arrow_down.png") no-repeat right center !important;
...
form .form-row:not(tr) {
  padding: 0 2px 25px;
  border-bottom-color: var(--dca-gray-lighter);
}
...
form .aligned label.vCheckboxLabel {
  display: inline;
}
form .aligned label.vCheckboxLabel + p {
  padding: 6px 0;
  margin-top: 0;
  margin-bottom: 0;
}
...
.form-row .select2-container.select2-container--admin-autocomplete .select2-selection {
  min-height: 36px;
}
.form-row .select2-container.select2-container--admin-autocomplete .select2-selection .select2-selection__arrow {
  height: 32px;
}
.form-row .select2-container.select2-container--admin-autocomplete .select2-selection .select2-selection__clear {
  margin-top: 5px;
}
...
input[type=submit][disabled]:before, input[type=submit][disabled]:hover:before, input[type=submit][disabled]:focus:before, input[type=submit][disabled]:active:before,
...
input[type=submit].default[disabled]:before, input[type=submit].default[disabled]:hover:before, input[type=submit].default[disabled]:focus:before, input[type=submit].default[disabled]:active:before,
input[type=button].default[disabled]:before,
input[type=button].default[disabled]:hover:before,
input[type=button].default[disabled]:focus:before,
...
a.button[disabled]:before, a.button[disabled]:hover:before, a.button[disabled]:focus:before, a.button[disabled]:active:before {
  opacity: 0.4 true;
}
a.button.tab {
  border-radius: 0;
...
div.calendar table td a:hover, div.calendar table td a:active, div.calendar table td a:focus {
  color: var(--dca-gray-darker);
  background: rgba(var(--dca-primary), 30%) !important;
}
...
div.clockbox .timelist li a:hover {
  background-color: rgba(var(--dca-primary), 30%) !important;
}
div.clockbox .calendar-cancel {
...
.calendar-shortcuts a[disabled]:active {
  ...
  opacity: 0.4;
  border-color: rgba(var(--dca-gray-lighter), 0.4) !important;
  color: rgba(var(--dca-primary), 0.8) true;
  cursor: not-allowed;
  box-shadow: none !important;
}
span.datetimeshortcuts a[disabled]:before, span.datetimeshortcuts a[disabled]:hover:before, span.datetimeshortcuts a[disabled]:focus:before, span.datetimeshortcuts a[disabled]:active:before,
.calendar-shortcuts a[disabled]:before,
.calendar-shortcuts a[disabled]:hover:before,
.calendar-shortcuts a[disabled]:focus:before,
...
span.datetimeshortcuts a:not(:last-child),
.calendar-shortcuts a:not(:last-child) {
  margin-right: 5px;
}
...
.related-widget-wrapper.widget-wrapper-links-1 select, .related-widget-wrapper.widget-wrapper-links-1 .select2 {
  width: calc(100% - 46px) !important;
}
.related-widget-wrapper.widget-wrapper-links-2 select, .related-widget-wrapper.widget-wrapper-links-2 .select2 {
  width: calc(100% - 87px) !important;
}
.related-widget-wrapper.widget-wrapper-links-3 select, .related-widget-wrapper.widget-wrapper-links-3 .select2 {
  width: calc(100% - 128px) !important;
}
.related-widget-wrapper.widget-wrapper-links-4 select, .related-widget-wrapper.widget-wrapper-links-4 .select2 {
...
#change-history td select + .add-another {
  ...
  border-radius: 5px;
  border: solid 1px var(--dca-gray-lighter);
  box-sizing: border-box;
}
...
#change-history tr.selected span {
  color: rgba(var(--dca-primary), 30%) !important;
}
...
#change-history tr.selected .lang-code {
  color: var(--dca-white) !important;
  font-size: 12px !important;
  background-color: var(--dca-gray-lighter) !important;
}
...
#change-history tbody tr:hover {
  background: rgba(var(--dca-primary), 30%);
}
...
.change-list .paginator {
  color: var(--dca-gray-light) !important;
  font-size: 12px !important;
  min-height: 20px;
...
.change-list #changelist-search input[type=submit][disabled]:before, .change-list #changelist-search input[type=submit][disabled]:hover:before, .change-list #changelist-search input[type=submit][disabled]:focus:before, .change-list #changelist-search input[type=submit][disabled]:active:before {
  opacity: 0.4 true;
}
.change-list #changelist-search input[type=submit]:active {
  background-image: url("../img/icon_search_white@2x.png") !important;
...
.plugin-holder .plugin-list-holder ul.plugin-list li.active {
  background: url("../img/bg-pattern-light.jpg") var(--dca-gray-lighter) repeat;
}
.plugin-holder .plugin-list-holder ul.plugin-list li.active:hover {
  background: var(--dca-white) url("../../cms/images/sitemap-li-bg.jpg") repeat-x 0 -100px;
}
...
#taggit_taggeditem_items-group .module {
  ...
  margin: 0;
  padding: 10px 0;
  border-top: solid 1px var(--dca-gray-lighter) !important;
  border-bottom: solid 1px var(--dca-gray-lighter) !important;
}
...
.djangocms-admin-style .submit-row .deletelink {
  background-image: none !important;
  margin-bottom: 0;
  padding: 6px 20px !important;
  border-radius: 3px !important;
...
.djangocms-admin-style .submit-row .deletelink:focus {
  color: var(--dca-gray-darker) !important;
  background-color: var(--dca-white) !important;
  border-color: var(--dca-gray-lighter) !important;
  filter: brightness(var(--focus-brightness)) !important;
...
.djangocms-admin-style .submit-row .deletelink:hover {
  color: var(--dca-gray-darker) !important;
  background-color: var(--dca-white) !important;
  border-color: var(--dca-gray-lighter) !important;
  filter: brightness(var(--focus-brightness)) !important;
...
.djangocms-admin-style .submit-row .deletelink:active {
  color: var(--dca-gray-darker) !important;
  background-color: var(--dca-white) !important;
  border-color: var(--dca-gray-lighter) !important;
  filter: brightness(var(--active-brightness)) !important;
...
.djangocms-admin-style .submit-row .deletelink:active:hover, .djangocms-admin-style .submit-row .deletelink:active:focus {
  color: var(--dca-gray-darker) !important;
  background-color: var(--dca-white) !important;
  border-color: var(--dca-gray-lighter) !important;
  filter: brightness(calc(var(--focus-brightness) * var(--active-brightness))) !important;
...
.djangocms-admin-style .submit-row .deletelink[disabled], .djangocms-admin-style .submit-row .deletelink[disabled]:hover, .djangocms-admin-style .submit-row .deletelink[disabled]:focus, .djangocms-admin-style .submit-row .deletelink[disabled]:active {
  background-color: var(--dca-white) !important;
  opacity: 0.4;
  border-color: rgba(var(--dca-gray-lighter), 0.4) !important;
  color: rgba(var(--dca-gray-darker), 0.8) true;
...
.djangocms-admin-style .submit-row .deletelink[disabled]:before, .djangocms-admin-style .submit-row .deletelink[disabled]:hover:before, .djangocms-admin-style .submit-row .deletelink[disabled]:focus:before, .djangocms-admin-style .submit-row .deletelink[disabled]:active:before {
  opacity: 0.4 true;
}
.djangocms-admin-style .submit-row .deletelink:before {
  content: "\E045";
}
...
#content-main .object-tools .addlink[disabled]:before, #content-main .object-tools .addlink[disabled]:hover:before, #content-main .object-tools .addlink[disabled]:focus:before, #content-main .object-tools .addlink[disabled]:active:before {
  opacity: 0.4 true;
}
...
.object-tools:before {
  ...
  width: 20px;
  left: -20px;
  background: linear-gradient(to right, rgba(var(--dca-gray-lightest), 0), var(--dca-gray-lightest));
}
.object-tools li {
  display: inline-block;
  float: none;
...
.object-tools li > a[disabled]:before, .object-tools li > a[disabled]:hover:before, .object-tools li > a[disabled]:focus:before, .object-tools li > a[disabled]:active:before {
  opacity: 0.4 true;
}
...
.object-tools .addlink[disabled]:before, .object-tools .addlink[disabled]:hover:before, .object-tools .addlink[disabled]:focus:before, .object-tools .addlink[disabled]:active:before {
  opacity: 0.4 true;
}
...
.object-tools .publishlink[disabled]:before, .object-tools .publishlink[disabled]:hover:before, .object-tools .publishlink[disabled]:focus:before, .object-tools .publishlink[disabled]:active:before {
  opacity: 0.4 true;
}
...
.object-tools .previewdraftlink[disabled]:before, .object-tools .previewdraftlink[disabled]:hover:before, .object-tools .previewdraftlink[disabled]:focus:before, .object-tools .previewdraftlink[disabled]:active:before {
  opacity: 0.4 true;
}
...
.object-tools .revertlink[disabled]:before, .object-tools .revertlink[disabled]:hover:before, .object-tools .revertlink[disabled]:focus:before, .object-tools .revertlink[disabled]:active:before {
  opacity: 0.4 true;
}
...
.object-tools .historylink[disabled]:before, .object-tools .historylink[disabled]:hover:before, .object-tools .historylink[disabled]:focus:before, .object-tools .historylink[disabled]:active:before {
  opacity: 0.4 true;
}
...
.object-tools .viewsitelink[disabled]:before, .object-tools .viewsitelink[disabled]:hover:before, .object-tools .viewsitelink[disabled]:focus:before, .object-tools .viewsitelink[disabled]:active:before {
  opacity: 0.4 true;
}
...
.delete-confirmation .colM input[type=submit][disabled]:before, .delete-confirmation .colM input[type=submit][disabled]:hover:before, .delete-confirmation .colM input[type=submit][disabled]:focus:before, .delete-confirmation .colM input[type=submit][disabled]:active:before {
  opacity: 0.4 true;
}
...
.parler-language-tabs span.current {
  color: var(--dca-primary) !important;
  border-bottom: solid 3px var(--dca-primary) !important;
  background: transparent !important;
}
...
.parler-language-tabs span.notfilled:focus {
  color: var(--dca-black) !important;
  border-bottom: solid 3px var(--dca-white) !important;
  background-color: var(--dca-white) !important;
}
...
.nani-language-tabs {
  position: relative;
  margin-bottom: -3px;
  border-bottom: 5px solid var(--dca-primary);
}
...
.dashboard #container #content-related {
  ...
  padding-top: 135px;
  margin: 0;
  border-left: 1px solid var(--dca-gray-lighter);
  background-color: var(--dca-gray-lightest);
}
...
body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:focus,
body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:active {
  background-color: var(--dca-primary) !important;
  opacity: 0.4;
  border-color: rgba(var(--dca-primary), 0.4) !important;
  color: rgba(var(--dca-white), 0.8) true;
...
body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:before, body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:hover:before, body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:focus:before, body.login.djangocms-admin-style #container #content #content-main .submit-row input[disabled]:active:before,
...
body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:focus:before,
body.login.djangocms-admin-style #container #content #content-main .submit-row input[type=submit][disabled]:active:before {
  opacity: 0.4 true;
}
...
#header .toolbar-item-navigation li ul li form {
  box-shadow: none;
  margin: 0;
  padding: 0;
}
#header .toolbar-item-navigation li ul li form button {
  float: none;
  white-space: nowrap;
  line-height: 30px;
  height: 30px;
...
#header .toolbar-item-navigation li ul li form button:active, #header .toolbar-item-navigation li ul li form button:focus {
  filter: none !important;
  box-shadow: none !important;
  text-decoration: underline !important;
}
#header .toolbar-item-navigation li ul li form button:hover {
  filter: none !important;
  color: var(--dca-white) !important;
  background: var(--dca-primary) !important;
  text-decoration: none !important;
...
#header #header-btn .btn.icon-arrow-right:focus {
  color: var(--dca-gray-darker) !important;
  background-color: var(--dca-white) !important;
  border-color: var(--dca-gray-darker) !important;
  filter: brightness(calc(var(--focus-brightness) * var(--active-brightness))) !important;
  text-decoration: none !important;
}
...
#drag_line {
  border-top: solid 4px var(--dca-primary) !important;
...
.cms-update-message {
  ...
  border-radius: 4px;
  background-color: rgba(var(--dca-primary), 0.1);
}
...
.djn-tabular .tabular .module .djn-items {
  border-left: 5px solid var(--dca-gray-lighter) !important;
  margin-left: 0;
}
...
.djangocms-admin-style .main .sticky {
  margin-top: 90px;
  border-top: 1px solid var(--dca-gray-lighter) !important;
}
...
.djangocms-admin-style .main #nav-sidebar input#nav-filter {
  font-size: 12px;
  width: 100% !important;
  max-width: none !important;
  height: 36px !important;
...
.djangocms-admin-style .main #nav-sidebar input#nav-filter:-moz-ui-invalid {
  box-shadow: none;
}
